...
class LLLEDFanBackendVerifications(VerifyCase):
    def verify_parse_status_builds_two_controllable_fans_and_global_mode(self):
    ...
    def verify_parse_status_marks_auto_mode_when_curve_daemon_is_running(self):
    ...
    def verify_parse_status_keeps_monitoring_when_write_confirmation_is_missing(self):
    ...
    async def verify_get_status_discovers_and_invokes_installed_llled_cgi(self):
        payload = llled_status()
    ...
    async def verify_set_percentage_uses_llled_fan_endpoint(self):
    ...
    async def verify_set_auto_mode_uses_exact_stock_profile_from_status(self):
    ...
    async def verify_set_full_speed_writes_both_fans_after_stopping_curve(self):
    ...
    async def verify_set_manual_recovers_to_half_speed_when_stopped_curve_was_at_full(self):
